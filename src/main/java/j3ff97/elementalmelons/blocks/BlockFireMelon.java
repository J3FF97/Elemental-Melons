...
public class BlockFireMelon extends Block
{
    ...
    {
        return ModItems.fireMelonSlice;
    }
    ...
    {
        sideIcon = icon.registerIcon(Reference.ID.toLowerCase() + ":fire_melon_side");
        topIcon = icon.registerIcon(Reference.ID.toLowerCase() + ":fire_melon_top");
    }
