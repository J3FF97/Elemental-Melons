...
{
    //Items
    public static final String skyMelonSlicename = "skyMelonSlice";
    public static final String earthMelonSlicename = "earthMelonSlice";
    public static final String waterMelonSlicename = "waterMelonSlice";
    public static final String fireMelonSlicename = "fireMelonSlice";
    public static final String skyMelonSeedsname = "skyMelonSeeds";
    ...
    public static final String itemFlaskname = "itemFlask";

    //Catalysts
    public static final String commonCatalystName = "commonCatalyst";
    public static final String skyCatalystName = "skyCatalyst";
    public static final String fireCatalystName = "fireCatalyst";
    public static final String earthCatalystName = "earthCatalyst";
    public static final String waterCatalystName = "waterCatalyst";
    ...
    public static final String infusedStonename = "infusedStone";
    ...
    {
        public static final String skySliceText = "Gives Haste for 20 seconds";
        public static final String waterSliceText = "Gives Water Breathing for 20 seconds";
