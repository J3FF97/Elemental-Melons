...
public class MelonGen implements IWorldGenerator
{
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
    {
        ...
        {
            addOreSpawn(ModBlocks.blockSkyMelon.getDefaultState(), world, random, Blocks.air, x, z, 15, 15, 3, 0.01, 148, 149 );
        }

        private void generateSurface(World world, Random random, int x, int z)
        {
            addOreSpawn(ModBlocks.blockWaterMelon.getDefaultState(), world, random, Blocks.water, x, z, 8, 8, 3, 2, 0, 256);
            addOreSpawn(ModBlocks.blockEarthMelon.getDefaultState(), world, random, Blocks.stone, x, z, 8, 8, 3, 10, 0, 256);

        }

        private void generateNether(World world, Random random, int x, int z)
        {
            addOreSpawn(ModBlocks.blockFireMelon.getDefaultState(), world, random, Blocks.netherrack, x, z, 8, 8, 3, 5, 0, 128);
        }
        ...
        **/
        ...
        public void addOreSpawn(IBlockState block, World world, Random random, Block target, int blockXPos, int blockZPos, int maxX, int maxZ, int maxVeinSize, double chancesToSpawn, int minY, int maxY)
        {
