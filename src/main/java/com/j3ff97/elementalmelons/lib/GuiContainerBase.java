package com.j3ff97.elementalmelons.lib;

import com.j3ff97.elementalmelons.ElementalMelons;
import com.j3ff97.elementalmelons.lib.widget.*;
...
public class GuiContainerBase extends GuiContainer implements IWidgetListener
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (inventory != null) {
            drawHorizontalAlignedString(7, 5, xSize - 14, I18n.format(inventory.getDisplayName() + ".name"), false);
        }
    }
    ...
    public void drawScreen(int x, int y, float partialTick) {
        ...
        boolean shift = ElementalMelons.proxy.isSneakingInGui();
        for (IGuiWidget widget : widgets) {
